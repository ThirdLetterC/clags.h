...
const examples = [_]Example{
    .{ .name = "01_basic", .source = "examples/01_basic.c" },
    .{ .name = "02_types", .source = "examples/02_types.c" },
    .{ .name = "03_1_lists", .source = "examples/03_1_lists.c" },
    .{ .name = "03_2_multi-lists", .source = "examples/03_2_multi-lists.c" },
    .{ .name = "04_choices", .source = "examples/04_choices.c" },
    .{ .name = "05_paths", .source = "examples/05_paths.c" },
    .{ .name = "06_custom", .source = "examples/06_custom.c" },
    .{ .name = "07_subcommands", .source = "examples/07_subcommands.c" },
    .{ .name = "08_image_processor", .source = "examples/08_image_processor.c" },
    .{ .name = "09_log_error_handling", .source = "examples/09_log_error_handling.c" },
};
